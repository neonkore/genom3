...
namespace boost { namespace python {
    ...
    class ptr_map_indexing_suite;

    namespace detail
    {
        template <class Container, bool NoProxy>
        class final_ptr_map_derived_policies
            : public ptr_map_indexing_suite<Container,
                NoProxy, final_ptr_map_derived_policies<Container, NoProxy> > {};
    }
    ...
    template <
        ...
        class DerivedPolicies
            = detail::final_ptr_map_derived_policies<Container, NoProxy> >
    class ptr_map_indexing_suite
    ...
    public:
        ...
        extension_def(Class& cl)
        {
            ...
            typedef typename mpl::if_<
              ...
              , /*default_call_policies*/ return_value_policy<reference_existing_object>
